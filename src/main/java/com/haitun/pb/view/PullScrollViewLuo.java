...
import com.haitun.pb.utils.ScreenUtils;

public class PullScrollViewLuo extends ScrollView {
    ...
    public PullScrollViewLuo(Context context){
		super(context);
	}
	public PullScrollViewLuo(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}
	public PullScrollViewLuo(Context context,AttributeSet attrs,int defStyle){
